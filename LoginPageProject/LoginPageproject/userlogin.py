...
def forget_pass():
    def change_password():
        if user_entry.get()=="" or newpass_entry.get()=="" or confirmpass_entry.get()=="":
            ...
            if row == None:
                ...
                query='update udata set password=%s where username=%s'
    ...
    backimgLabel.grid()
    hedingLabel= Label(window,text='RESET PASSWORD',font=('arial','18','bold'),bg='white',fg='magenta2')
    ...
    submitButton=Button(window,text='Submit',bd=0,bg='magenta2',fg='white',font=('Open Sans','16','bold'),
                        width=19,cursor='hand2',activeforeground='white',activebackground='magenta2',command=change_password)
...
def login_user():
    if usernameEntry.get()=="" or passwordEntry.get()=="":
        ...
        query='select * from udata where username=%s and password=%s'
...
heading=Label(login_window,text='USER LOGIN',font=('microsoft yahei UI Light',18,'bold'),bg='white',fg='firebrick1')
heading.place(x=620,y=120)

usernameEntry=Entry(login_window ,width=20,font=('microsoft yahei UI Light',11,'bold'),bd=0,fg='firebrick1')
...
passwordEntry=Entry(login_window ,width=20,font=('microsoft yahei UI Light',11,'bold'),bd=0,fg='firebrick1')
...
forgetButton=Button(login_window,text='Forget Password?',bd=0,bg='white',activebackground='white',cursor='hand2',
                    font=('microsoft yahei UI Light',10,'bold'),activeforeground='firebrick1',fg='firebrick1',command=forget_pass)
forgetButton.place(x=715,y=295)

loginButton=Button(login_window,font=('Open sans',16,'bold'),text='Login',fg='white',bg='firebrick1',
...
orlable=Label(login_window,text='-------------- OR --------------',font=('Open sans',16,'bold'),fg='firebrick1',bg='white')
...
googe_logo=PhotoImage(file='google.png')
...
newaccountButton=Button(login_window,font=('Open sans',9,'bold underline'),text='Create new one',fg='blue',bg='white',
